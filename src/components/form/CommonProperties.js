...
export const Styles= {
    ...
    checkBoxHeight:'20px',
    checkBoxWidth:'20px',
    checkBoxBGColor:'#EF8F21',
    checkBoxColor:THEME.white,
    checkBoxRadius:'20%',
    // ---- RadioButtons
    radioBtnHeight:'20px',
    radioBtnWidth:'20px',
    radioBtnActiveBGColor:THEME.green,
    radioBtnBGColor:THEME.white,
    radioBtnBorderColor:THEME.gray,
    radioBtnRadius:'50%',
    // ------ Tab Active Color
    tabActiveBarColor:THEME.red,
    // ------ SwitchActive Color
    switchActiveColor:THEME.red,
}
