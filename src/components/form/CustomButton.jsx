...
const whistlistButtonStyles = css`
  color:${THEME.white};
...
const PlainButton = styled(AntdButton)`
  ...
  ${props => props.type === 'addCart' && addCartButtonStyles};
  ${props => props.type === 'whistlist' && whistlistButtonStyles};
...
const Primary = ({ text,style, icon, ...props }) => (
    <PlainButton style={style} {...props} type="primary">
...
const AddCart = ({ text, style, icon, ...props }) => (
  <PlainButton style={style} {...props} type="addCart">
...
const Whishlist = ({ text, icon,style, ...props }) => (
  <PlainButton style={style} {...props} type="whistlist">
      <Flex style={{alignItems:"center"}} gap={'10px'}>
          {icon}
          <TextContainer style={{color:'#FAB442'}} icon={icon ? "true" : "false"}>{text}</TextContainer>
      </Flex>
  </PlainButton>
)
...
Button.AddCart = AddCart
Button.Whishlist = Whishlist
