...
const AntdInputStyle = styled(AntdInput)`
  ...
  border-radius: ${props => props.borderRadius || '0.4rem'}; /* default to 0.4rem */
  box-shadow: none;
  border-color: ${props => (props.error ? 'red' : '#d9d9d9')};
  background: #fdecda !important;
  background: ${props => props.background || "#fdecda"}!important;
  ...
  :hover {
  border: ${props => props.border || "#b3d8ff"}!important;
